...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				DrawAdvancedText(0.130 - x, 0.77 - y, 0.005, 0.0028, 0.6, mph, 255, 255, 255, 255, Config.Font, 1)
				--DrawAdvancedText(0.174 - x, 0.77 - y, 0.005, 0.0028, 0.6, kmh, 255, 255, 255, 255, 6, 1)
				--DrawAdvancedText(0.2195 - x, 0.77 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.174 - x, 0.77 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 255, 255, Config.Font, 1)
				DrawAdvancedText(0.148 - x, 0.7765 - y, 0.005, 0.0028, 0.4, " MPH              FUEL", 255, 255, 255, 255, Config.Font, 1)
			else
				Citizen.Wait(750)
			end
		end
